...
const processingSteps = [
  { agent: "screening", message: "Screening Agent analyzing video content...", duration: 2000 },
  { agent: "screening", message: "Extracting eye gaze patterns...", duration: 1500 },
  { agent: "screening", message: "Analyzing behavioral signals...", duration: 2000 },
  { agent: "clinical", message: "Clinical Summary Agent processing data...", duration: 1500 },
